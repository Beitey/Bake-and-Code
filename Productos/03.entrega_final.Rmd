...
tbl_2
```
Podemos ver que el porcentaje del "Pan de mantequilla y frijoles rojos" tiene un porcentaje que no varia tanto durante el día, al igual que en el caso de los bebestibles, el resto no nos da información para concluir que el horaio afecta en sus ventas.
