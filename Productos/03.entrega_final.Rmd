...
+-----------------+----------------------------------------------------+
| 23 columnas de  | Estas corresponden a los productos, entre los      |
| diferentes      | cuales podemos encontrar sándwiches, cafés, tés y  |
| productos       | pasteles. Los valores de las columnas corresponden |
|                 | a un número que indica cuantas unidades fueron     |
|                 | solicitadas.                                       |
+-----------------+----------------------------------------------------+
